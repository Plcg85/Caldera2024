...
public class CrearArchivoIniciacion {
    ...
    public static void crearArchivoInicial() throws IOException {
        ...
        FileWriter fw = new FileWriter("C:\\ServidorCaldera\\PExec.dat"); //se crea el archivo para que ya no se creen mas veces las bd
...
}//final clase CrearArchivoIniciacion
